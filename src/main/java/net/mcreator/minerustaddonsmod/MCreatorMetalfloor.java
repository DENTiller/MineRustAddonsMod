...
public class MCreatorMetalfloor extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:metalfloor")
	public static final Block block = null;

	public MCreatorMetalfloor(minerustaddonsmod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("minerustaddonsmod:metalfloor",
				"inventory"));
	}
	...
	public static class BlockCustom extends BlockFalling {
		...
		public BlockCustom() {
			super(Material.IRON);
			setRegistryName("metalfloor");
			setUnlocalizedName("metalfloor");
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing side,
			...
			Block block = this;
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				MCreatorMetalflooruparmored.executeProcedure($_dependencies);
			}
			return true;
		}
	}
