...
public class MCreatorSmallchestgui extends minerustaddonsmod.ModElement {

	public static int GUIID = 2;
	public static HashMap guiinventory = new HashMap();
	public static IInventory inherited;

	public MCreatorSmallchestgui(minerustaddonsmod instance) {
		super(instance);
	}
	...
	public static class GuiContainerMod extends Container {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			if (ent instanceof MCreatorSmallchest.TileEntityCustom)
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minerustaddonsmod:textures/smallchestgui.png");
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Small Chest Inventory", 4, 4, -16777216);
		}
