...
public class MCreatorStoneaxe extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:stoneaxe")
	public static final Item block = null;

	public MCreatorStoneaxe(minerustaddonsmod instance) {
		super(instance);
		instance.items.add(() -> new ItemToolCustom() {
		}.setUnlocalizedName("stoneaxe").setRegistryName("stoneaxe").setCreativeTab(MCreatorToolsTab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minerustaddonsmod:stoneaxe", "inventory"));
	}
	...
	private static class ItemToolCustom extends ItemTool {
		...
		protected ItemToolCustom() {
			super(EnumHelper.addToolMaterial("STONEAXE", 1, 100, 0f, 1f, 0), EFFECTIVE_ON);
