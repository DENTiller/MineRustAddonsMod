...
public class MCreatorChocolatebar extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:chocolatebar")
	public static final Item block = null;

	public MCreatorChocolatebar(minerustaddonsmod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minerustaddonsmod:chocolatebar", "inventory"));
	}
