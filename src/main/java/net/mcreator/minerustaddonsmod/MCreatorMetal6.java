...
public class MCreatorMetal6 extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:metal6")
	public static final Block block = null;

	public MCreatorMetal6(minerustaddonsmod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minerustaddonsmod:metal6", "inventory"));
	}
