...
public class MCreatorWood3 extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:wood3")
	public static final Block block = null;

	public MCreatorWood3(minerustaddonsmod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader
				.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("minerustaddonsmod:wood3", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.WOOD);
			setRegistryName("wood3");
			setUnlocalizedName("wood3");
