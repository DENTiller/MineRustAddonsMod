...
public class MCreatorMetal3 extends minerustaddonsmod.ModElement {

	@GameRegistry.ObjectHolder("minerustaddonsmod:metal3")
	public static final Block block = null;

	public MCreatorMetal3(minerustaddonsmod instance) {
		super(instance);
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minerustaddonsmod:metal3", "inventory"));
	}
	...
	public static class BlockCustom extends Block {
		...
		public BlockCustom() {
			super(Material.IRON);
			setRegistryName("metal3");
			setUnlocalizedName("metal3");
